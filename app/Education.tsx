...
const NEWS_API_URL = `https://newsapi.org/v2/top-headlines?category=business&apiKey=${NEWS_API_KEY}`;
    ...
    >
      <View style={styles.container}>
        <View style={styles.textContainer}>
          <Text variant="headlineSmall" style={styles.text}>Education News</Text>
